  ...
  return(
    <div key={contentKey} className="flex flex-col items-center gap-2 py-2 px-8 my-4">
      <div className="my-4 flex flex-col items-center relative group">
        { image && <img src={typeof(image) === "string" ? image : URL.createObjectURL(image)} alt="" className="w-[600px] h-[400px] rounded-md" /> }
        <div className="flex items-center justify-center absolute w-full h-full invisible group-hover:visible bg-gray-50 opacity-80 rounded-md">
          <Button
            component="label"
            role={undefined}
            variant="contained"
